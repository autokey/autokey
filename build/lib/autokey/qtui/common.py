...
def display_wayland_warning():
    if os.environ.get('WAYLAND_DISPLAY'):
        QMessageBox.information(None, "Wayland Support",
                                "AutoKey is running with experimental Wayland support. Some features may not work as expected.")
