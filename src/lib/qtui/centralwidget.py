...
# coding=UTF-8
#
# Generated by pykdeuic4 from centralwidget.ui on Tue Apr 13 12:52:38 2010
#
...
class Ui_CentralWidget(object):
    ...
    def retranslateUi(self, CentralWidget):
        ...
        self.treeWidget.headerItem().setText(0, kdecore.i18n("Name"))
        self.treeWidget.headerItem().setText(1, kdecore.i18n("Abbr."))
        self.treeWidget.headerItem().setText(2, kdecore.i18n("Hotkey"))
