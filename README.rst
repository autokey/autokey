...
**Important**: AutoKey supports both X11 and Wayland. The ``develop`` branch provides Wayland support (particularly for GNOME and KDE Plasma). See ``wayland_install.md`` for installation instructions on Wayland.
